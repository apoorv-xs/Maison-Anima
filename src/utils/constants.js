// App constants — single source of truth for magic numbers
...
export const AUDIO_MASTER_GAIN = 0.045;

// Customizer
export const CUSTOMIZER_ZOOM_SCALE = 2.3;

// Dev
export const DEV_SERVER_PORT = 8724;
